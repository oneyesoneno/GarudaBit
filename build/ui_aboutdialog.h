...
public:
    ...
    QLabel *label_peershares_copyright;
    QLabel *label_2;
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_peershares_copyright = new QLabel(AboutDialog);
        label_peershares_copyright->setObjectName(QString::fromUtf8("label_peershares_copyright"));
        label_peershares_copyright->setWordWrap(true);
        label_peershares_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_peershares_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Peershares", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>Peershares</b> : version", 0, QApplication::UnicodeUTF8));
        label_peershares_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2013-2014 Peershares Developers", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2012-2013 The Peercoin Developers\n"
