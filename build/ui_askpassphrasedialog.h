...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        formLayout->setWidget(1, QFormLayout::LabelRole, passLabel1);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, passEdit1);

        passLabel2 = new QLabel(AskPassphraseDialog);
        passLabel2->setObjectName(QString::fromUtf8("passLabel2"));

        formLayout->setWidget(2, QFormLayout::LabelRole, passLabel2);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, passEdit2);

        passLabel3 = new QLabel(AskPassphraseDialog);
        passLabel3->setObjectName(QString::fromUtf8("passLabel3"));

        formLayout->setWidget(3, QFormLayout::LabelRole, passLabel3);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, passEdit3);
...
"}"));
    ...
    {
        AskPassphraseDialog->setWindowTitle(QApplication::translate("AskPassphraseDialog", "Dialog", 0, QApplication::UnicodeUTF8));
